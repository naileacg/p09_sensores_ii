...
Cabe destacar que generé un apk para cada uno de los ejercicios, de forma que se puedan probar de forma más simple.
...
Para este ejercicio cree un Script muy simple ([SensorUI.cs](Scripts/SensorUI.cs)) que lee en tiempo los sensores que estén disponibles del móvil y muestra sus valores en la interfaz.

![Ejercicio1](media/ejercicio1.png)

- El **apk** generado es el siguiente: [ejercicio1](apk/ejercicio1.apk)

AÑADIR CAPTURAS EN EL JARDÍN Y EL LABORATORIO
...
El objetivo es claro: **Que el guerrero siempre mire al norte.**

Para lograr esto vamos a utilizar el sensor de 
